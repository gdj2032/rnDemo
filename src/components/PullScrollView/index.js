...
export default class PullScrollView extends Component {
  ...
  onPanResponderMove(e, gesture) {
    if (isUpGesture(gesture.dx, gesture.dy)) {
      ...
      if (gesture.dy < this.topRefreshHeight + this.pullOkMargin) {
        //正在下拉
  ...
  isPullState() {
    return (
      this.curState.pulling || this.curState.pullok || this.curState.pullrelease
    );
  }
  ...
  */
  defaultTopRefreshRender(pulling, pullok, pullrelease) {
    ...
    setTimeout(() => {
      if (pulling) {
        this.txtPulling &&
          this.txtPulling.setNativeProps({ style: styles.show });
        this.txtPullok && this.txtPullok.setNativeProps({ style: styles.hide });
        this.txtPullrelease &&
          this.txtPullrelease.setNativeProps({ style: styles.hide });
      } else if (pullok) {
        this.txtPulling &&
          this.txtPulling.setNativeProps({ style: styles.hide });
